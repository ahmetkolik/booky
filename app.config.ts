...
export const appConfig: AppConfig = {
  ...
  marketing: {
    ...
    stats: [
      ...
      { value: "0%", label: { tr: "rezervasyon komisyonu", en: "booking fees" } },
    ],
    pricing: [
      {
        name: "Solo",
        ...
        features: [
          ...
          { tr: "Takvim & hatırlatmalar", en: "Calendar & reminders" },
      ...
      },
      {
        ...
        price: "$79",
        period: { tr: "/ay", en: "/mo" },
        tagline: { tr: "Çok lokasyonlu salonlar için.", en: "For multi-location studios." },
        features: [
          { tr: "Sınırsız personel", en: "Unlimited staff" },
          { tr: "Çoklu lokasyon", en: "Multiple locations" },
          { tr: "Roller & izinler", en: "Roles & permissions" },
          { tr: "Gelişmiş raporlar", en: "Advanced reports" },
          { tr: "Özel destek", en: "Dedicated support" },
        ],
        cta: { tr: "Satışla görüş", en: "Talk to sales" },
      },
    ],
    faq: [
  ...
  navGroups: [
    ...
    },
    {
      ...
      items: [
        { label: { tr: "Hizmetler", en: "Services" }, href: "/dashboard", icon: "scissors", muted: true },
        { label: { tr: "Personel", en: "Staff" }, href: "/dashboard", icon: "user-cog", muted: true },
        { label: { tr: "Rezervasyon sayfası", en: "Booking page" }, href: "/dashboard", icon: "globe", muted: true },
      ],
    },
  ],
